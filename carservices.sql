...
CREATE TABLE `towns` (
  ...
  `town` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idmunicipios_UNIQUE` (`id`),
  KEY `FK_STATETOWN` (`state_id`),
  CONSTRAINT `FK_STATETOWN` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `workshops` (
  ...
  CONSTRAINT `workshops_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`workshop_id`) REFERENCES `workshops` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla car_owners
# ------------------------------------------------------------
...
CREATE TABLE `car_owners` (
  ...
  KEY `town_id` (`town_id`),
  CONSTRAINT `car_owners_ibfk_1` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`),
  CONSTRAINT `car_owners_ibfk_2` FOREIGN KEY (`town_id`) REFERENCES `towns` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Volcado de tabla notification_types
# ------------------------------------------------------------
...
INSERT INTO `notification_types` (`id`, `description`)
VALUES
  (0,'Request car owner agree service order'),
  (1,'Request car owner agree diagnostic'),
  (2,'Request car owner agree quote'),
  (3,'Request car owner agree car delivery'),
  (4,'Request car owner update km'),
  (5,'Request car owner do car service');
...
CREATE TABLE `notifications` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `car_owner_id` int(11) unsigned NOT NULL,
  ...
  KEY `type` (`type`),
  CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`car_owner_id`) REFERENCES `car_owners` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`type`) REFERENCES `notification_types` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla car_brands
# ------------------------------------------------------------
...
# Volcado de tabla car_models
# ------------------------------------------------------------

CREATE TABLE `car_models` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `car_brand_id` int(11) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `car_brand_id` (`car_brand_id`),
  CONSTRAINT `car_models_ibfk_1` FOREIGN KEY (`car_brand_id`) REFERENCES `car_brands` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
VALUES
	(2,'Versa',1,NULL,NULL),
	(3,'Altima',1,NULL,NULL),
	(4,'Sentra',1,NULL,NULL),
	(5,'Matiz',2,NULL,NULL),
	(6,'Spark',2,NULL,NULL),
	(7,'Aveo',2,NULL,NULL),
	(8,'Sonic',2,NULL,NULL);
...
CREATE TABLE `cars` (
  ...
  `km` int(11) NOT NULL,
  `license_plate` varchar(25) NOT NULL DEFAULT '',
  ...
  CONSTRAINT `cars_ibfk_1` FOREIGN KEY (`car_owner_id`) REFERENCES `car_owners` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla reminders
# ------------------------------------------------------------
...
CREATE TABLE `reminders` (
  ...
  `time_unit` varchar(50) NOT NULL DEFAULT '',
  `next_reminder` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `next_reminder` (`next_reminder`),
  KEY `car_id` (`car_id`),
  CONSTRAINT `reminders_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla service_statuses
# ------------------------------------------------------------
...
INSERT INTO `service_statuses` (`id`, `description`)
VALUES
  (0,'Pendiente'),
  (1,'En proceso'),
...
# Volcado de tabla service_orders
# ------------------------------------------------------------
...
CREATE TABLE `service_orders` (
  ...
  `workshop_id` int(11) unsigned NOT NULL,
  `owner_supplied_parts` tinyint(1) NOT NULL DEFAULT '0',
  `owner_allow_used_parts` tinyint(1) NOT NULL DEFAULT '0',
  ...
  KEY `user_id` (`user_id`),
  KEY `workshop_id` (`workshop_id`),
  CONSTRAINT `service_orders_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `service_orders_ibfk_2` FOREIGN KEY (`car_owner_id`) REFERENCES `car_owners` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `service_orders_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `service_orders_ibfk_4` FOREIGN KEY (`workshop_id`) REFERENCES `workshops` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



ALTER TABLE `cars` ADD CONSTRAINT `cars_ibfk_2` FOREIGN KEY (`service_order_id`) REFERENCES `service_orders` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;


# Volcado de tabla scheduled_services
# ------------------------------------------------------------
...
CREATE TABLE `scheduled_services` (
  ...
  KEY `car_id` (`car_id`),
  KEY `service_order_id` (`service_order_id`),
  CONSTRAINT `scheduled_services_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`),
  CONSTRAINT `scheduled_services_ibfk_2` FOREIGN KEY (`service_order_id`) REFERENCES `service_orders` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Volcado de tabla service_inventories
# ------------------------------------------------------------
...
CREATE TABLE `service_inventories` (
  ...
  `brake_fluid` varchar(20) DEFAULT NULL,
  `wiper_fluid` varchar(20) DEFAULT NULL,
  `antifreeze` varchar(20) DEFAULT NULL,
  `oil` varchar(20) DEFAULT NULL,
  `power_steering_fluid` varchar(20) DEFAULT NULL,
  `date` timestamp NULL DEFAULT NULL,
  `closed_date` timestamp NULL DEFAULT NULL,
  `agree_date` timestamp NULL DEFAULT NULL,
  `disagree_date` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `service_order_id` (`service_order_id`),
  KEY `user_id` (`user_id`),
  KEY `status` (`status`),
  CONSTRAINT `service_inventories_ibfk_1` FOREIGN KEY (`service_order_id`) REFERENCES `service_orders` (`id`),
  CONSTRAINT `service_inventories_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `service_inventories_ibfk_3` FOREIGN KEY (`status`) REFERENCES `service_statuses` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla service_photos
# ------------------------------------------------------------

CREATE TABLE `service_photos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `service_inventory_id` int(11) unsigned NOT NULL,
  `type` varchar(50) NOT NULL,
  `photo` mediumblob NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `service_inventory_id` (`service_inventory_id`),
  CONSTRAINT `service_photos_ibfk_1` FOREIGN KEY (`service_inventory_id`) REFERENCES `service_inventories` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla service_diagnostics
# ------------------------------------------------------------
...
CREATE TABLE `service_diagnostics` (
  ...
  `front_shock_absorber` varchar(10) DEFAULT NULL,
  `rear_shock_absorber` varchar(10) DEFAULT NULL,
  `front_brakes` varchar(10) DEFAULT NULL,
  `rear_brakes` varchar(10) DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id_diagnostic` (`service_order_id`),
  KEY `service_diagnostics_ibfk_2` (`user_id`),
  KEY `status` (`status`),
  CONSTRAINT `service_diagnostics_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `service_diagnostics_ibfk_2` FOREIGN KEY (`service_order_id`) REFERENCES `service_orders` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `service_diagnostics_ibfk_3` FOREIGN KEY (`status`) REFERENCES `service_statuses` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla service_quotes
# ------------------------------------------------------------
...
CREATE TABLE `service_quotes` (
  ...
  `status` int(11) unsigned NOT NULL,
  `user_id` int(11) unsigned DEFAULT NULL,
  `subtotal` float(9,2) NOT NULL DEFAULT '0.00',
  `tax` float(9,2) NOT NULL DEFAULT '0.00',
  `total` float(9,2) NOT NULL DEFAULT '0.00',
  `advance_payment` float(9,2) NOT NULL DEFAULT '0.00',
  `date` timestamp NULL DEFAULT NULL,
  `closed_date` timestamp NULL DEFAULT NULL,
  `agree_date` timestamp NULL DEFAULT NULL,
  `disagree_date` timestamp NULL DEFAULT NULL,
  ...
  KEY `status` (`status`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `service_quotes_ibfk_1` FOREIGN KEY (`service_order_id`) REFERENCES `service_orders` (`id`),
  CONSTRAINT `service_quotes_ibfk_2` FOREIGN KEY (`status`) REFERENCES `service_statuses` (`id`),
  CONSTRAINT `service_quotes_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


# Volcado de tabla service_quote_items
# ------------------------------------------------------------

CREATE TABLE `service_quote_items` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `service_quote_id` int(11) unsigned NOT NULL,
  `description` varchar(200) NOT NULL,
  `amount` decimal(6,5) NOT NULL,
  `subtotal` decimal(9,2) NOT NULL DEFAULT '0.00',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `service_quote_id` (`service_quote_id`),
  CONSTRAINT `service_quote_items_ibfk_1` FOREIGN KEY (`service_quote_id`) REFERENCES `service_quotes` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tokens` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `car_owner_id` int(11) unsigned DEFAULT NULL,
  ...
  KEY `car_owner_id` (`car_owner_id`),
  KEY `token` (`token`),
  CONSTRAINT `tokens_ibfk_1` FOREIGN KEY (`car_owner_id`) REFERENCES `car_owners` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `towns` (`id`, `state_id`, `town`)
VALUES
  (1,1,'Aguascalientes'),
  (2,1,'Asientos'),
  (3,1,'Calvillo'),
