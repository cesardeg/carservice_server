    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">            
            <div class="navbar-header">                
                ...
                <a class="navbar-brand"><img src="{{ URL::to('/') }}/img/hqh.png" style="width:60px;height:25px;"></a>
            ...
            <ul class="nav navbar-top-links navbar-right">            
                <li class="dropdown">
                    <a href="{{ URL::to('/logoutadm') }}"><i class="fa fa-sign-out fa-fw"></i> Cerrar sesión</a>
                </li>
            </ul>
            <!-- /.navbar-top-links -->    
                ...
                <div class="sidebar-nav navbar-collapse">                    
                    <div class="panel panel-info">
                        ...
                        <a class="list-group-item">
                            <i class="fa fa-user"></i> <?php echo Auth::user()->first_name . ' ' .  Auth::user()->last_name?>
                            <span class="pull-right text-muted small">
                            </span>
                        </a>
                        <a class="list-group-item">
                            <i class="fa fa-building-o"></i> <?php echo 'Taller: ' . Auth::user()->workshop->name ?>
                            <span class="pull-right text-muted small">
                            </span>
                        </a>
                    </div>                                                                              
                    <ul class="nav" id="side-menu">                       
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/operators_list') }}">Listado</a>
                                </li>                                                        
                            </ul>
                            <!-- /.nav-members-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/carsinworkshop') }}">En Taller</a>
                                </li>                            
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('/workshophistory') }}">Listado</a>
                                </li>                               
                            </ul>
                            <!-- /.nav-memberships-level -->
                        </li>                                 
